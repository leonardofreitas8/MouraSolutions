...
namespace MouraSolutionsWeb.Controllers
{
    public class MaterialController : Controller
    {
        ...
        public MaterialController(MouraExpressContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
